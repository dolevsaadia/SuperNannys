...
export const verificationController = {
  async submit(req: Request, res: Response) {
    const result = await verificationService.submit(req.user!.id, req.body)
  ...
  async review(req: Request, res: Response) {
    ...
    const result = await verificationService.review(req.params.id, req.user!.id, status, adminNotes)
    res.json({ data: result })
  },
}
