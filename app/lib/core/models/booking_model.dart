...
class BookingModel {
  ...
  factory BookingModel.fromJson(Map<String, dynamic> json) => BookingModel(
        ...
        // Convert UTC → local so display matches the time the user originally selected
        ...
        occurrenceDate: json['occurrenceDate'] != null ? DateTime.parse(json['occurrenceDate'] as String).toLocal() : null,
        ...
        actualStartTime: json['actualStartTime'] != null ? DateTime.parse(json['actualStartTime'] as String).toLocal() : null,
        actualEndTime: json['actualEndTime'] != null ? DateTime.parse(json['actualEndTime'] as String).toLocal() : null,
